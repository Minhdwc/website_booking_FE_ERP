    ...
    <div className="w-full max-w-md">
      <div className="flex items-center gap-3 lg:hidden">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400">Hệ thống quản lý nội bộ</p>
        </div>
      </div>

      <div className="mb-1">
        <h1 className="text-2xl font-black tracking-tight text-slate-900">Tạo tài khoản</h1>
        ...
        <form onSubmit={onSubmit} noValidate className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="••••••••"
                className="h-10 border-slate-200 bg-white pl-9 pr-10 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 hover:border-slate-300 focus-visible:border-[#4c90d3] focus-visible:ring-2 focus-visible:ring-[#4c90d3]/20 dark:!bg-white dark:!text-slate-900 dark:border-slate-200"
          ...
          <div className="space-y-1.5">
            <div className="flex items-start gap-2.5">
              ...
              <Label
                htmlFor="acceptTerms"
                className="text-sm leading-snug font-normal text-slate-600"
              >
                Tôi đồng ý với{' '}
                <Link
                  href="/dieu-khoan"
